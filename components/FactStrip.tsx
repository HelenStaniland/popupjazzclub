  ...
  return (
    <div className="border-b border-border/40 bg-surface">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <p className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 py-3 text-center text-xs uppercase tracking-[0.22em] text-cream-muted sm:gap-x-4 sm:py-4 sm:text-sm">
